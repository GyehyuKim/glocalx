...
> 입력 문서: `docs/readinggo-discussion.md`, `docs/협동-기반-독서-루틴-조사.md`
...
- 비공개 모드 옵션: 문장을 본인만 보기 가능. **같은 책 피드와 친구 피드 모두에서 숨김**. 스트릭/공동 자산 기여에는 영향 없음
- 박수 받음 인지: 푸시 알림 X. 다음 앱 진입 시 홈 상단에 "X명이 박수를 보냈어요" 배지로 통지
