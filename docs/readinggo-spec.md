...
|---|---|---|---|
| **OCR (책 사진 → 문장 자동 추출)** | 2026-05-22 | 외부 API 비용. 학기 범위 정당화 불가 | 무료/저렴한 디바이스 내장 OCR 안정화, 또는 수익 모델 확정 |
| **음성 받아쓰기 (STT)** | 2026-05-22 | 외부 API 비용 | 무료 Web Speech API 한국어 품질 충분 확인 시 |
